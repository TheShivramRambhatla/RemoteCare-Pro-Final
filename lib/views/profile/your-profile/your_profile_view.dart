...
class _YourProfileViewState extends State<YourProfileView> {
  TextEditingController nameController =
      TextEditingController(text: "Shivram Rambhatla");
  // TextEditingController nameController =
          ...
          child: Column(
            ...
            children: [
              ...
              const CustomInputFieldWidget(
                  fieldName: "Phone Number", hindText: "8985917858"),
              const SizedBox(
                height: 10,
              ),
              const CustomInputFieldWidget(
                  fieldName: "Email", hindText: "Shivram.Rambhatla@gmail.com"),
              const SizedBox(
                height: 10,
              ),
              const CustomInputFieldWidget(
                  fieldName: "DOB", hindText: "27/04/2004"),
            ],
          ),
        ),
      ),
